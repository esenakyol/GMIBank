...
public class US_016_Page {
    ...
    public void clickToWebElement(String element) {
        ...
        switch (element) {
            ...
            case "myOperationsDropDown":
                myElement = myOperationsDropDown;
                break;

            case "myAccounts":
                myElement = myAccounts;
                break;

            case "transferMoney":
                myElement = transferMoney;
                break;

            case "fromAccount":
                myElement = fromAccount;
                break;
